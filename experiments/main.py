...
def table_strategies_choiced(
    ...
    for scenario, results_dict_i in results_dict.items():
        ...
        target_vacc = params["target_product_id"]
        target_vacc = {
            "bivalent": "Bivalent HPV vaccine",
            "quadrivalent": "Quadrivalent HPV vaccine",
            "nonavalent": "Nonavalent HPV vaccine",
        }[target_vacc]
...
def get_budget_df(
    ...
    assert vacc_reimburse + gov_rate + busi_rate + person_rate == 1.0, (
